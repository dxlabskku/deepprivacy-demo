...
const uploadSlice = createSlice({
    ...
    reducers: {
        ...
        setFinalFiles: (state, action: PayloadAction<{
            relationship: string,
            data: string
        }>) => {
            if (action.payload.relationship === 'original') {
                state.finalFiles.original = action.payload.data
            }
            if (action.payload.relationship === 'positive') {
                state.finalFiles.positive = action.payload.data;
            }
            if (action.payload.relationship === 'neutral') {
                state.finalFiles.neutral = action.payload.data;
            }
            if (action.payload.relationship === 'negative') {
                state.finalFiles.negative = action.payload.data;
            }
        }
    },
    extraReducers: (build) => {
