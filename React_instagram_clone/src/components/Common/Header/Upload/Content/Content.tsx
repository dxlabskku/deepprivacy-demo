            ...
            <StyledContent>
                ...
                >
                    <div
                        ...
                        {currentFile.newUrl !== "" && (
                            <div className="image__outerwrapper">
                                <div className="image__wrapper">
                                    <h1 className="image__subtitle">Original</h1>
                                    <img
                                        src={finalFiles.original}
                                        alt={"태그할 수 있는 사진"}
                                ...
                                <div className="image__wrapper">
                                    <h1 className="image__subtitle">to Friends</h1>
                                    <img
                                        src={finalFiles.positive}
                                        alt={"태그할 수 있는 사진"}
                                        className="image__display"
                                        onClick={ImgClickHandler}
                                    />
                                ...
                                <div className="image__wrapper">
                                    <h1 className="image__subtitle">to Stangers</h1>
                                    <img
                                        src={finalFiles.neutral}
                                        alt={"태그할 수 있는 사진"}
                                        className="image__display"
                                        onClick={ImgClickHandler}
                                    />
                                ...
                                <div className="image__wrapper">
                                    <h1 className="image__subtitle">to Stalkers</h1>
                                    <img
                                        src={finalFiles.negative}
                                        alt={"태그할 수 있는 사진"}
                                        className="image__display"
                                        onClick={ImgClickHandler}
                                    />
                    ...
                    <div className="upload__contentsScroll">
                        <div className="upload__contentInput textareaBox">
                            <div className="textarea__header">
                                <img
                                    src={"profiles/lucas.thomas.jpg"}
                                    alt={"유효하지 않은 url입니다."}
                                />
                                <div>{userInfo?.memberUsername}</div>
                            </div>
                            <textarea
                                placeholder="Insert Texts..."
                                value={textareaValue}
                                onChange={(event) =>
                            ...
                            <>
                                <div className="upload__contentOption location">
                                    <div className="header">
                                        <input
                                            // disabled={true}
                                            placeholder="Location(Under development)"
                                        />
                                        <span>
                                            <LocationIcon />
                                        </span>
                                    ...
                                    {isAccessOptionOn && (
                                        <div className="activated accessOption">
                                            <div className="smallFont">
                                                {`Alternative texts are the text provided for visual impairments that describe the content of the image. Alternate texts are automatically generated based on your images, or you can provide by yourself.`}
                                            </div>
                                            {files.map((file, index) => (
                                                <div key={file.newUrl}>
                                                    ...
                                                    <input
                                                        type="text"
                                                        placeholder="Insert alternative texts..."
                                                        value={
                                    ...
                                    {isAdvancedOptionOn && (
                                        <div className="activated advanced">
                                            <div className="toggleArea">
                                                <div>
                                                    Hide likes and views on this post
                                                </div>
                                                <div
                                                    onClick={() =>
                                                        dispatch(
                                            ...
                                            <div className="smallFont">
                                                Total likes are views are only visible to you. You can change this setting later on the ··· button on the right. If you want to hide likes of others, then proceed to account settings.
                                            </div>
                                            <div className="toggleArea">
                                            ...
                                            <div className="smallFont">
                                            You can change this setting later on the ··· button on the right. 
                                            </div>
                                        </div>
                                    )}
                                </div>
